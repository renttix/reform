      ...
      <section className="container mx-auto px-4 py-12">
        ...
        <div className="max-w-xl mx-auto">
          <div className="relative w-full mb-8">
            ...
            {isOpen && (
              <div className="absolute z-10 w-full mt-2 bg-white dark:bg-reform-dark rounded-lg shadow-xl border border-gray-100 dark:border-gray-700">
                <a
                  href="https://www.eventbrite.co.uk/o/reform-uk-51817792123"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-6 py-4 hover:bg-reform-gray dark:hover:bg-reform-dark/50 rounded-t-lg transition-colors duration-200 text-reform-dark dark:text-white"
                  onClick={() => setIsOpen(false)}
                >
                  <div className="font-semibold mb-1">National Events</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">View all ReformUK national events on Eventbrite</div>
                </a>
                <a
                  href="https://www.facebook.com/groups/916932353577131/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="block px-6 py-4 hover:bg-reform-gray dark:hover:bg-reform-dark/50 rounded-b-lg transition-colors duration-200 text-reform-dark dark:text-white"
                  onClick={() => setIsOpen(false)}
                >
                  <div className="font-semibold mb-1">Regional Events</div>
                  <div className="text-sm text-gray-600 dark:text-gray-300">Join our Facebook group for local events and updates</div>
                </a>
              </div>
            )}
          </div>
        ...
        <div className="mt-16 max-w-2xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-6 text-reform-dark dark:text-white">Want to Host an Event?</h2>
