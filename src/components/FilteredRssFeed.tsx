...
export default function FilteredRssFeed({ feedUrl, title, areaFilters }: FilteredRssFeedProps) {
    ...
    return (
      <div className="text-center py-8">
        ...
        <p className="text-gray-600 dark:text-gray-300">
          No recent news found for your local area. Please check back later.
        </p>
      </div>
    )
  }
